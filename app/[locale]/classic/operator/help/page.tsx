        ...
        articles: [
          {
            ...
            steps: [
              '【下单】餐馆自助下单，或运营在「下单」页面代客下单，选好商品提交。',
              ...
              '【开票】配送完成后系统自动生成发票草稿，运营核对后点「确认发票」完成开票。',
            ],
    ...
    sections: [
      {
        ...
        articles: [
          ...
          },
          {
            ...
            title: '下单后能修改吗？',
            steps: [
              '订单提交后，如状态为「待拣货」，请联系运营人员协助修改或取消。',
              '一旦进入「拣货中」状态，订单已进入仓库作业流程，无法直接修改。',
            ],
            note: '建议在截单时间前完成下单，一般截单时间由运营人员告知。',
          },
        ],
      },
      {
        ...
        articles: [
          ...
          },
          {
            ...
            steps: [
              ...
              '波次状态变为「已完成」，运营人员和分货员会收到通知。',
            ],
            note: '如实际数量与订单不符，必须填写备注说明，方便运营跟进处理。',
          },
        ],
      },
    ],
        ...
        articles: [
          ...
          },
          {
            ...
            steps: [
              ...
              '客户不在无人收货：拍摄门口照片作为凭证，在备注填写"无人收货"，联系运营人员协调处理。',
              '收款金额有误：据实填入实际收到的金额，如有差异在备注中说明，财务会对账跟进。',
            ],
            note: '所有异常情况都必须在备注中记录说明，方便运营人员后续处理。',
          },
        ],
      },
    ],
