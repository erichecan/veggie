 ...
 * ============================================================================
 * 2026-08-18 客户要求定的口径，当时所有单据打印共用这一份。20260914 客户改要求：
 * 送货单/发票/销售单/签收单四类客户单据改用下面的 sortLinesByUomSequence（装货顺序），
 * 商品 sequence 降级成装货顺序打平时的次级键；采购单（vendor 侧）没受影响，仍用这个。
 *
